...
Utilisation de LLM comme assistant pour une assistance partagée lors du développement de ce site web, ainsi que sur la génération d'articles.
---
...
**Lien vers la vidéo :** Le lien de la vidéo est dans le remis Moodle
